...
<div class="mb-20 mt-20">
    <form method="POST" action="{{ route('departments.store') }}">
        @csrf
        <label for="email" class="block text-sm font-medium text-gray-700">Create a New Departement</label>
        <div class="mt-1 flex rounded-md shadow-sm">
            <div class="relative flex items-stretch flex-grow focus-within:z-10">
                ...
                <input value="{{ old('name') }}" type="text" name="name" id="name" class="focus:ring-indigo-500 focus:border-indigo-500 block w-full rounded-none rounded-l-md pl-10 sm:text-sm border-gray-300" placeholder="name">
            </div>
